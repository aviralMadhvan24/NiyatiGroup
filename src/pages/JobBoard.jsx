    ...
    const fetchJobs = async () => {
      ...
      const jobData = querySnapshot.docs.map(doc => {
        ...
        return { 
          ...
          ...data,
          lastDate,
          formattedSalary: data.salary ? 
            new Intl.NumberFormat('en-IN').format(data.salary) : null,
          // Determine status based on lastDate
                      ...
                      <div className="flex flex-wrap items-center gap-4 mt-3 text-sm">
                        ...
                        {job.salary && (
                          <div className="flex items-center text-gray-400">
                            ...
                            <span>₹{job.formattedSalary}/month</span>
                          </div>
                        )}
                        {job.duration && (
                          <div className="flex items-center text-gray-400">
                        ...
                        {job.lastDate && (
                          <div className="flex items-center text-gray-400">
                            ...
                            <span>Apply by: {job.lastDate.toLocaleDateString()}</span>
                          </div>
                        )}
                      </div>
                    </div>
