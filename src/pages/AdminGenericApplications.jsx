                ...
                >
                  ...
                  <div className="mb-4">
                    <span className="block text-gray-400">
                      Location: <span className="text-white">{app.location}</span>
                    </span>
                    <span className="block text-gray-400">
                      Experience: <span className="text-white">{app.experience}</span>
                    </span>
                    <span className="block text-gray-400">
                      Applied on: <span className="text-white">{app.createdAt}</span>
                    </span>
                  </div>
