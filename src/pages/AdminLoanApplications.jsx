              ...
              {applications.map((app, idx) => (
                ...
                >
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-white">₹{app.loanAmount}</p>
                        </div>
                        <div>
                          <p className="text-sm text-gray-500">Tenure</p>
                          <p className="text-white">{app.tenure} months</p>
                        </div>
                        <div>
                          <p className="text-sm text-gray-500">Employment</p>
                          <p className="text-white">{app.employment}</p>
                        </div>
                        <div>
                          <p className="text-sm text-gray-500">Monthly Income</p>
                          <p className="text-white">₹{app.income}</p>
                        </div>
                        <div>
                          <p className="text-sm text-gray-500">PAN</p>
                          <p className="text-white">{app.pan}</p>
                        </div>
                        {app.remarks && (
                          <div className="md:col-span-2">
                            <p className="text-sm text-gray-500">Remarks</p>
                            <p className="text-white">{app.remarks}</p>
                          </div>
                        )}
                      </div>
                    </div>
                    ...
                    <div className="space-y-4">
                      <div>
                        <p className="text-sm text-gray-500">Loan Offer</p>
                        <p className="text-white font-medium">{app.offerTitle || "N/A"}</p>
                      </div>
