          ...
          >
            ...
            <address className="not-italic space-y-3">
              ...
              <div className="flex items-start">
                ...
                <a href="mailto:info@niyatigroup.com" className="text-sm text-gray-400 hover:text-blue-400 transition-colors">info@niyatigroup.com</a>
              </div>
              ...
              <div className="flex items-start">
                ...
                <a href="tel:+919876543210" className="text-sm text-gray-400 hover:text-blue-400 transition-colors">+91 98765 43210</a>
              </div>
            </address>
