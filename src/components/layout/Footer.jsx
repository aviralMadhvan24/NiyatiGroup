    ...
    <footer className="relative bg-gradient-to-br from-teal-900 via-teal-950 to-slate-950 text-gray-300 pt-16 pb-10 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-full">
          <div className="absolute inset-0 opacity-10 bg-[linear-gradient(to_right,#14b8a612_1px,transparent_1px),linear-gradient(to_bottom,#14b8a612_1px,transparent_1px)] bg-[size:24px_24px]"></div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10 mb-12">
          ...
          >
            <div className="flex items-center">
              <motion.div 
                className="bg-teal-600 w-10 h-10 rounded-2xl flex items-center justify-center"
              ...
              {Object.entries(socialLinks).map(([social, url], index) => {
                ...
                return (
                  <motion.a
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="bg-teal-900/50 p-2 rounded-lg border border-teal-800 hover:border-teal-500/30 text-gray-400 hover:text-teal-400 transition-all"
                    initial={{ opacity: 0 }}
                ...
                >
                  ...
                  >
                    <svg 
                      ...
                      className="mr-2 opacity-0 group-hover:opacity-100 transition-opacity text-teal-400"
                    >
          ...
          >
            ...
            <address className="not-italic space-y-3">
              <div className="flex items-start">
                <div className="bg-teal-500/10 p-1.5 rounded-lg mr-3 border border-teal-500/20">
            ...
            <div className="pt-2">
              <motion.button
                ...
                className="w-full px-4 py-2.5 bg-teal-600 hover:bg-teal-700 rounded-lg cursor-pointer text-sm text-white font-medium transition-colors"
              >
        ...
        {/* Bottom Copyright */}
        <motion.div 
          className="border-t border-teal-800/50 pt-6 text-center"
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
          viewport={{ once: true }}
